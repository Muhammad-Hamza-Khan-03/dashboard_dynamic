...
class ImprovedMermaidGenerator:
    ...
    def _setup_model(self):
        self.model = ChatGroq(api_key=self.GROQ_API_KEY, model_name="llama3-groq-70b-8192-tool-use-preview")
    ...
    def _get_diagram_instructions(self, diagram_type):
        base_instructions = """You are an expert in creating complex and creative Mermaid diagrams. Your task is to generate a detailed Mermaid diagram based on the user's request. Follow these guidelines:
        ...
        3. Include creative elements that go beyond basic representations.
        ...
        Generate a complex and creative Mermaid diagram code based on the user's request."""
